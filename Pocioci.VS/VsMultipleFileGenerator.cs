...
namespace Pocioci.VS
{
    public abstract class VsMultipleFileGenerator<IterativeElementType> : IEnumerable<IterativeElementType>, IVsSingleFileGenerator, IObjectWithSite
    {
        ...
        private IVsGeneratorProgress _generateProgress;
        ...
        protected IVsGeneratorProgress GenerateProgress
        {
            get { return _generateProgress; }
        }
        ...
        {
            this._generateProgress = pGenerateProgress;
